...
export const CATEGORY_RULES: CategoryRule[] = [
  ...
  { id: "star-wars", label: "Star Wars", priority: 150, patterns: [/\bstar wars\b/i, /\bdarth\b/i, /\banakin\b/i, /\byoda\b/i, /\bahsoka\b/i, /\bpalpatine\b/i, /\bpadm[eé]\b/i, /\bwindu\b/i, /\bgrievous\b/i, /\b66\b/i, /\bjedi\b/i, /\bsith\b/i, /\bluke(?:\s+skywalker)?\b/i, /\bobi[ -]?wan\b/i, /\bkenobi\b/i, /\bqui[ -]?gon\b/i, /\bleia\b/i, /\bmandalor(?:ian)?\b/i] },
